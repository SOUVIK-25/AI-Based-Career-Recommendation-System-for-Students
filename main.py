...
def main():
    ...
    st.write(
        """
        Welcome to the Career Recommendation System. This tool helps university students
    ...
    st.header("📊 Subject Scores in percentage")
    ...
    if submit_button:
        ...
        if average_score < 40:
            st.warning(" Your average score is below 40. Please aim to pass in all subjects before proceeding.")
        else:
